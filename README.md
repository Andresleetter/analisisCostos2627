...
- **Gastos** (trabajos medidos en Horas o Litros, no en Unidades): "Construcción de puentes x horas" (Servicio `Construccion de Puentes retro excavadora x Hs`, distinto de los dos de arriba) y "Desalijos" (no está en el presupuesto — se buscó "desalijo" en Servicio y Observación; agrupa dos usos reales distintos de esa palabra, excluyendo las filas cuyo Servicio ya se cuenta en otra sección para no duplicar horas/costo).
