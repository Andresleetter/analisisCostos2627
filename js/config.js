...
const RECETAS_INSUMO_ALIAS = [
  ...
  // (El alias IOP FULL -> Iop de SOJA se quito el 21/09/2026: el presupuesto de agosto ya escribe
  // "Iop Full", igual que Albor, y la receta de SOJA se cargo con ese nombre.)
